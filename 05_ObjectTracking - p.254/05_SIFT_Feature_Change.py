...
cap = cv2.VideoCapture(
    "/Users/park.s.w/Documents/GitHub/09_PreProcess/99_Studyfile/02_Sample/vtest.avi"
)

sift = cv2.SIFT_create(contrastThreshold=0.02)  # 대비 임계값 : 0.02 / 낮으면 낮은 특징점 검출
